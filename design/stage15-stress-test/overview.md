...
> **Stage status, 2026-08-01: reopened with new scope.**
...
> initialization — designed, not started) and **W9** (six defects found while
> measuring W8's design — reported, not fixed). Nothing about W1–W7 changed;
> the stage simply has more in it.
