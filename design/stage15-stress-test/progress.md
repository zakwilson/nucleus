...
close**: twenty defects were found across the whole effort, two are now fixed,
and the reconciled open count is **eighteen** — see the W9 section below for
...
## W9 — Reconciled at stage close: twenty defects found, two now fixed, eighteen open *(added 2026-08-01; extended through G-5's close 2026-08-02; reported except where marked FIXED)*
...
interlude and G-4 — gives a union of **twenty** unique items. **Two are now
fixed**: the fn-pointer `defvar` collision (§7 #9, fixed in the interlude
between G-3 and G-4) and the `as` want-channel gap (§7 #12, fixed in G-5).
The reconciled **open** count is **eighteen**. Items 14–20 below are that
