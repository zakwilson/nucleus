...
- [stage11/progress.md](stage11/progress.md) — Stage 11 detailed progress table (T0–T6: status, what landed, key functions touched — `StructTemplate`, `register-struct-template`, `struct-template-stamp-types`, `sanitize-for-c`, etc.)
